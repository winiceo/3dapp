...
!function (a, b, c, d) {
    ...
    var t = function () {
        ...
        var g = a("<support>").get(0).style, h = ["webkit", "Moz", "O", "ms"], i = {
            transition: {
                end: {
    ...
    o.options = {
        ...
        loading: {
            appendTo: "panel", template: function (a) {
        ...
        initialize: function (a) {
            ...
            if (!this._builded) {
                var b = this.options, c = b.template.call(this, b), d = this;
        ...
        initialize: function (a) {
            ...
            if (!this._builded) {
                var b = this._view.options, c = b.loading.template.call(this, b);
    ...
    var v = {
        prepareTransition: function (b, c, d, e, f) {
            ...
            w.enter("animating");
            var g = b.options.duration, h = b.options.easing || "ease", i = this, j = b.makePositionStyle(d);
            ...
            if (b.options.useCssTransitions && t.transition)setTimeout(function () {
                ...
                var l = e(), m = b.getPosition(), n = d, o = function (d) {
    ...
    a.extend(m.prototype, {
        initialize: function (a) {
            this._view = a, this.options = a.options, this._drag = {time: null, pointer: null}, this.bindEvents()
        }, bindEvents: function () {
            var b = this.options, c = this._view.$panel;
        ...
        initialize: function (b) {
            var c = arguments[1] || {};
            if ("string" == typeof b)b = {url: b}; else if (b && 1 == b.nodeType) {
                var d = a(b);
                b = {url: d.attr("href"), settings: d.data("settings") || {}, options: d.data() || {}}
            }
            return b.options = b && b.options ? a.extend(!0, c, b.options) : c, b.options = a.extend(!0, {}, o.options, b.options), a.extend(this, b), this
        }
    });
    var w = {
        _states: {}, _views: {}, _current: null, is: function (a) {
            ...
            var e = Array.prototype.slice.call(arguments, 2), f = [c].concat(e);
            ...
            var b = this.getView(a.options), c = this, d = function () {

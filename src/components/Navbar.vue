<template>
   <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega bg-teal-600" role="navigation">
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
                ...
                <span class="navbar-brand-text"> KuaiPing</span>
            </div>
        ...
        <div class="navbar-container container-fluid">
            ...
            <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                ...
                <div style="margin-top:15px;margin-left:40px;">
                        <a  href="/3d/main.html" class="btn btn-success  js-external-link"  >
                                          <span class="ladda-label"><i class="icon wb-play margin-right-10" aria-hidden="true"></i>播放</span>
                                        </a>

                         </div>
                    <a href="#" class="btn btn-success  js-external-link">
                     <span class="ladda-label" onclick="TogetherJS(this); return false;"><i class="icon wb-play margin-right-10" aria-hidden="true"></i>播放</span>
                    </a>

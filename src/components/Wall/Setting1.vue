        ...
        <div class="row" data-plugin="matchHeight" data-by-row="true" styel="text-alien:center">
            ...
            <table class='mytable'>
                ...
                <tr><td style='text-align:left'>
                    ...
                    URL（服务器地址）： http://wall-dev.71an.com/kphd-entry/473efc1e4ba3971d493ac2624282dbf6
                    <br>
                    Token（令牌）： 5823e7cdb1f15
                    <br>
    ...
    export default{
        ...
        methods: {
            ...
            get_userinfo: function () {
                ...
                api(_vm).get(_vm.app.api + '/user/profile' ).then(function (data) {
